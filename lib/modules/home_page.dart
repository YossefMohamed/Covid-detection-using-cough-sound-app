...
class _HomePageState extends State<HomePage> {
  ...
  void initState() {
    super.initState();
    //SystemChrome.setEnabledSystemUIOverlays([SystemUiOverlay.top]); // hide bottom bar | allow control only from app behavior
    _getCurrentLocation();
                    ...
                    child: Container(
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                            ...
                            children: <Widget>[
                              ...
                              Container(
                                ...
                                padding: const EdgeInsets.only(
                                    left: 5, right: 16, top: 6, bottom: 6),
                                child: Row(
                                  children: [
                                    const Icon(
                                      Icons.location_on,
                          ...
                          const Text(
                            "Click Below To Make Test or Scroll Down For Your Government Help.",
                            style: TextStyle(
